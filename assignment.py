...
def policy_improvement(P, nS, nA, value_from_policy, policy, gamma=0.9):
    ...
    for state in range(nS):
        ...
        for action in range(nA):
            ...
            value_from_action[state][action] = P[state][action][0][2] + gamma*P[state][action][0][0]*value_from_policy[P[state][action][0][1]]
